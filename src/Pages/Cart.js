...
import { emptyCart } from "../Assets/index.js";
...
const Cart = () => {
  ...
  return (
    <div className="w-full bg-gray-100 p-4">
      {products.length > 0 ? (
        <div className="container mx-auto h-auto flex flex-col lgl:grid grid-cols-5 gap-8">
          <div className="w-full h-full bg-white px-4 col-span-4">
            <div className="font-titleFont flex items-center justify-between border-b-[1px] border-b-gray-400 py-3">
              <h2 className="text-3xl font-medium">Shopping Cart</h2>
              <h4 className="text-xl hidden lgl:inline-block font-normal">
                SubTotal
              </h4>
            </div>
            {/*Product*/}
            <div>
              {products.map((item) => (
                <div
                  ...
                  <div className="w-3/5 lgl:w-4/5  ">
                    <h2 className="font-semibold text-lg">{item.title}</h2>
                    <p className="text-sm hidden lgl:inline-block">
                  ...
                  <div>
                    <p className="text-lg  hidden lgl:inline-block font-titleFont font-semibold">
        ...
        <motion.div
          ...
          <div className="w-90 md:w-96 p-4 bg-white flex flex-col items-center rounded-md shadow-lg">
            <h1 className="font-titleFont text-xl font-bold">
              Your Cart feels lonely
            </h1>
            <p className="text-sm text-center">
              Your shopping cart lives to serve . Give it purpose - fill it with
              books ,electronics,video,etc. and make it happy.
            </p>
            <Link to="/">
